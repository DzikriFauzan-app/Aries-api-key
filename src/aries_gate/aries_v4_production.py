...
async def chat(request: Request):
    ...
    MATH_RULES = {
        "aries": "v4.0 PRODUCTION | Math S3 PhD + Programmer S3 PhD + Kosmologi | OPENAI READY",
    ...
    return {"choices":[{"message":{"content":"🤖 ARIES v4.0: Math+Programming+Science+Kosmologi PhD PRODUCTION READY!"}}]}
